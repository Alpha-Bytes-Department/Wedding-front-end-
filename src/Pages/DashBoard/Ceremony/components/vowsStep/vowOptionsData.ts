...
// ─── Charge Options ───
export const chargeOptions: VowOption[] = [
  {
    id: "charge1",
...
// ─── Pledge Options ───
export const pledgeOptions: VowOption[] = [
  {
    id: "pledge1",
...
// ─── Vow Introduction Options ───
export const vowIntroOptions: VowOption[] = [
  {
    id: "vowIntro1",
...
// ─── Vow Options ───
export const vowOptions: VowOption[] = [
  {
    id: "vow1",
...
// ─── Reading Options ───
export const readingOptions: VowOption[] = [
  {
    id: "reading1",
...
// ─── Ring Introduction Options ───
export const ringIntroOptions: VowOption[] = [
  {
    id: "ringIntro1",
...
// ─── Ring Blessing Options ───
export const ringBlessingOptions: VowOption[] = [
  {
    id: "blessing1",
    label: "Divine Faith",
    content:
...
// ─── Ring Exchange Options (Groom) ───
export const ringExchangeGroomOptions: VowOption[] = [
  {
    id: "groomRing1",
...
// ─── Ring Exchange Options (Bride) ───
export const ringExchangeBrideOptions: VowOption[] = [
  {
    id: "brideRing1",
    label: "Traditional Sacred",
    content:
...
// ─── Prayer Options ───
export const prayerOptions: VowOption[] = [
  {
    id: "prayer1",
    label: "Marriage Blessing",
    content:
...
/** All option arrays mapped by field name */
const fieldOptionsMap: Record<string, VowOption[]> = {
  chargeToGroomAndBride: chargeOptions,
  pledge: pledgeOptions,
  introductionToExchangeOfVows: vowIntroOptions,
  vows: vowOptions,
  readings: readingOptions,
  introductionToExchangeOfRings: ringIntroOptions,
  blessingsOfRings: ringBlessingOptions,
  exchangeOfRingsGroom: ringExchangeGroomOptions,
  exchangeOfRingsBride: ringExchangeBrideOptions,
  prayerOnTheNewUnion: prayerOptions,
};

/** Get options array for a given field name */
export const getOptionsForField = (fieldName: string): VowOption[] =>
  fieldOptionsMap[fieldName] || [];

/** Get all options across every category */
export const getAllOptions = (): VowOption[] =>
  Object.values(fieldOptionsMap).flat();

/** Replace name placeholders in content */
...
/** Find which field name an option ID belongs to */
export const getFieldForOptionId = (optionId: string): string | null => {
  for (const [fieldName, options] of Object.entries(fieldOptionsMap)) {
    if (options.some((opt) => opt.id === optionId)) return fieldName;
  }
  return null;
};
