      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="form-control">
          <input
            ...
            className="input bg-white input-bordered border-primary w-full focus:outline-primary"
          />
          {errors.name && (
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="form-control">
          ...
          <input
            ...
            accept="image/*"
            className="file-input  bg-white file-input-bordered border-primary w-full"
          />
